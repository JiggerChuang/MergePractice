    ...
    $("#startButton").click(function(){
        if(currentQuiz==null){
            ...
            for(var x=0; x<questions[0].answers.length; x++){
                $("#questions").append("<input name='options' type='radio' value="+x+">"+"<label>"+
            ...
            $.each($(":radio"), function(i, val){
                if(val.checked){
                    if(ifNaN(questions[currentQuiz].answers[i][1])){
                        var finalResult = questions[currentQuiz].answers[i][1];
                        $("#question").text(finalAnsers[finalResult][0]);
                        $("#options").empty();
                        ...
                        for(var x=0; x<questions[currentQuiz].answers.length; x++){
                            $("#questions").append("<input name='options' type='radio' value="+x+">"+
